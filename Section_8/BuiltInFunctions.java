public class BuiltInFunctions {
    ...
    public static void main(String[] args) {
        ...
        String lowerString = upperCase.toLowerCase();
        ...
        boolean specifiedPrex = programming.startsWith("Java");
        System.out.println( "Does programming starts with Java: " + specifiedPrex);
        // Write your code here
        ...
        String updateString = original.replace("a", "b");
        ...
        double overAllNum = Math.sqrt(number);
        System.out.println(overAllNum);
        // Write your code here
        ...
        double powerNum = Math.pow(base, exponent);
        ...
        int largetTwoNum = Math.max(number1, number2);
        System.out.println(largetTwoNum);
