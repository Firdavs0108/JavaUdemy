public class MathOperations {
    public static void main(String[] args) {
        ...
        System.out.println("Fred has " + (starsInAndromeda - starsInMilkyWay) + " more sweets than George");
        ...
        System.out.println("5 is an odd number, since dividing 5 by 2 has a remainder of:" + (1%2));
